...
export const Footer = () => {
	return (
		<div id="footer" class="extended-background">
			<section>
				<Row className='mx-3 py-5'>
					...
					<Col sm={5} className='text-center'>
						<ul class="list-group">
							<li className="list-group-item"><a className='text-decoration-none fw-500' href='#about_us'>¿Quienes somos?</a></li>
							<li className="list-group-item"><a className='text-decoration-none fw-500' href='#products'>Productos</a></li>
							<li className="list-group-item"><a className='text-decoration-none fw-500' href='#blog'>Blog</a></li>
							<li className="list-group-item"><a className='text-decoration-none fw-500' href='#contact_us'>Contacto</a></li>
						</ul>
					</Col>
