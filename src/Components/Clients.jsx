...
export const Clients = () => {
	const clientsInfo = [
		...
		{ name: "Integra conecta", image: "./images/Clientes/Integra conecta.png" },
		{ name: "Integra med", image: "./images/Clientes/Integramed.png" },
		{ name: "Mega Direct", image: "./images/Clientes/Mega Direct.png" },
		...
		{ name: "Red de colegios", image: "./images/Clientes/Red de colegios.png" },
